...
struct Fuse(Movable):
    ...
    def __init__(out self, *, deinit move: Self):
        self.collection = move.collection^
        self.threshold = move.threshold
        self.distance = move.distance
        self.location = move.location
        self.min_match_char_length = move.min_match_char_length
        self.include_matches = move.include_matches
        self.should_sort = move.should_sort
        self.find_all_matches = move.find_all_matches
        self.ignore_location = move.ignore_location
